...
## 🟡 WARNINGS
- [x] Namibian sports news ingestion research — `docs/research/NAMIBIAN_SPORTS_NEWS_SOURCES.md`; RSS Phase 1 wired in `news-aggregator` (opt-in `ENABLE_NEWS_AGGREGATOR`); no outlet APIs; deploy Edge Function + cron still ops
