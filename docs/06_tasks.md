...
- [x] Testing T4 (2026-07-25): DB-first federationScope matrix — `federationScopeDbFirst.test.ts` (media + coaches/hp update/delete + upload ownership); expanded `safeHttpsHref` / news sourceUrl cases
