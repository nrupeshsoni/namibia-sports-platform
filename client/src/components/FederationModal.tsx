...
export default function FederationModal({ federation, onClose }: FederationModalProps) {
  ...
  const open = federation !== null;

  const federationSlug = federation ? getFederationSlug(federation) : "";
  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="fixed inset-4 md:inset-8 lg:inset-12 z-50 top-auto left-auto translate-x-0 translate-y-0 max-w-none w-auto h-auto p-0 gap-0 overflow-hidden rounded-3xl border-0 bg-transparent shadow-none sm:max-w-none"
        style={{
      ...
      >
        {federation && (
          <>
            <DialogTitle className="sr-only">{federation.name}</DialogTitle>
            <DialogDescription className="sr-only">
              {federation.description ||
                `${getCategoryLabel(federation.category)} — federation details`}
            </DialogDescription>
            ...
            <div className="h-full max-h-[calc(100vh-2rem)] md:max-h-[calc(100vh-4rem)] lg:max-h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
              <div className="relative h-72 md:h-96 w-full overflow-hidden">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${getCategoryGradient(federation.category)} mix-blend-overlay`}
                />
              ...
              <div className="p-8 md:p-12 -mt-20 relative z-10">
                ...
                {hasSafeSocial && (
                  <motion.div
                    ...
                    className="mb-8"
                  >
                    <h2 className="text-xl font-serif tracking-wider mb-4 text-white/80">
                      CONNECT
                    </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  >
                    <h2 className="text-xl font-serif tracking-wider mb-5 text-white/80">
                      CONTACT
                    </h2>
                ...
                >
                  <motion.button
                    ...
                    onClick={() => {
                      onClose();
                      navigate(`/federation/${federationSlug}`);
                    }}
                  ...
                  <motion.button
                    ...
                    onClick={() => {
                      onClose();
                      navigate(`/federation/${federationSlug}/clubs`);
                    }}
                  ...
                  <motion.button
                    ...
                    onClick={() => {
                      onClose();
                      navigate(`/federation/${federationSlug}/events`);
                    }}
                    className="px-8 py-4 rounded-xl font-medium text-white transition-all"
                    style={{
                      background: "rgba(255, 255, 255, 0.1)",
