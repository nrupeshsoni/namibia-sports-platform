...
export default function FedAdminCoaches({ federationId }: { federationId?: number }) {
  ...
  const coaches = (coachesQuery.data ?? []) as CoachFormData[];
  ...
  return (
    <div className="space-y-6">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
              ...
              <th className="text-left px-4 py-3 text-xs tracking-widest text-gray-400">Specialization</th>
          ...
          <tbody>
            {coachesQuery.isLoading ? (
              ...
              <tr>
                <td colSpan={4} className="px-4 py-8 text-center text-gray-500">No coaches found.</td>
              </tr>
            ) : (
              filtered.map((c) => (
                <tr
                ...
                >
                  ...
                  <td className="px-4 py-3 text-sm text-gray-400">{c.specialization ?? "—"}</td>
      ...
      <EntityModal
        ...
        title={modal?.mode === "create" ? "Add Coach" : "Edit Coach"}
      >
        {modal && (
          <CoachForm
            mode={modal.mode}
            federationIdLock={federationId}
      ...
      {deleteId != null && (
        ...
        >
          ...
          >
            <p className="text-white font-medium">Delete this coach?</p>
